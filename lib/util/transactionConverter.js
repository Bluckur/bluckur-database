function addTransactionState(accumelator, publicKey, type, amount, isRecipient) {
...
module.exports = {
  convertToTransactionStates(transactions) {
    return transactions.reduce((accumelator, {
      recipient, sender, amount, type,
    }) => {
      addTransactionState(accumelator, recipient, type, amount, true);
      addTransactionState(accumelator, sender, type, amount);
      return accumelator;
    });
  },
};
